...
import static ru.mycrg.integration_service.bpmn.IJavaDelegateProperties.IMPORT_GPKG_BACKWARD_FILE_CREATE;
...
public class ImportGpkgCreateFilesBackwardEventHandler implements IEventHandler {
    ...
    public void handle(IMessageBusEvent mqEvent) {
        ...
        runtimeService.createMessageCorrelation("Mes_FromDataCreateFilesGpkg")
                      ...
                      .setVariable(IMPORT_GPKG_BACKWARD_FILE_CREATE, asJava(backward))
                      .correlateWithResult();
    }
}
