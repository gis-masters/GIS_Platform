...
public class UpdateFileRelation implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        ImportGpkgCreateFilesBackwardEvent fileCreateAnswer = (ImportGpkgCreateFilesBackwardEvent)
                delegateExecution.getVariable(IMPORT_GPKG_BACKWARD_FILE_CREATE);
        ...
        List<UUID> currentFileIds = (List<UUID>) delegateExecution.getVariable(IMPORT_GPKG_FILES_LIST);
        ...
        String table = (String) delegateExecution.getVariable(IMPORT_GPKG_CREATED_TABLE_NAME);

        //TODO: когда нибудь добавить ретраи. Камунда процесс уже ожидает "responseTimeOut"
        ResponseModel<Object> response = dataServiceSpeaker.patchCurrentFeature(event.getToken(),
                                                                                dataset,
                                                                                table,
                                                                                fileDataProps,
