...
public class OrgDepRemovingSuccessEventDelegate implements JavaDelegate {
    ...
    public OrgDepRemovingSuccessEventDelegate(MessageBusSender messageBusSender) {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        messageBusSender.sendOrgEvent(new OrganizationDependencyRemovingSucceededEvent(event));
    }
}
