...
import static ru.mycrg.integration_service.bpmn.IJavaDelegateProperties.IMPORT_GPKG_BACKWARD_EXTRACTED_DATA;
...
public class ImportGpkgAckInfoBackwardEventHandler implements IEventHandler {
    ...
    public void handle(IMessageBusEvent mqEvent) {
        ...
        runtimeService.createMessageCorrelation("Mes_FromDataAckInfoFromGpkg")
                      ...
                      .setVariable(IMPORT_GPKG_BACKWARD_EXTRACTED_DATA, asJava(backward))
                      .correlateWithResult();
    }
}
