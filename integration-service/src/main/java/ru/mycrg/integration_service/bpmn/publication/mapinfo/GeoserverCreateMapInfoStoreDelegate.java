//package ru.mycrg.integration_service.bpmn.publication.mapinfo;
//
...
//
//@Service("geoserverCreateMapInfoStoreDelegate")
//public class GeoserverCreateMapInfoStoreDelegate implements JavaDelegate {
//
//    private final Logger log = LoggerFactory.getLogger(GeoserverCreateMapInfoStoreDelegate.class);
//
//    @Override
//    public void execute(DelegateExecution execution) throws Exception {
//        log.debug("execute GeoserverCreateMapInfoStoreDelegate");
//
//        try {
...
//                log.debug("Successfully created MapInfo store with params: [{}]", dto);
//
...
//            }
//        } catch (Exception e) {
//            log.error("Failed to execute step: 'GeoserverCreateMapInfoStoreDelegate'. Cause: {}",
...
//        return "Не удалось создать MapInfo хранилище на геосервере";
//    }
//}
