...
VALUES
    (
        ...
        '2319368',
        'jpg',
        '/opt/crg/specializations/7/data/files/photo1.jpg',
        'image/jpeg',
        'FEATURE',
        '{}'
    ),
    (
        ...
        '1875456',
        'jpg',
        '/opt/crg/specializations/7/data/files/photo2.jpg',
        'image/jpeg',
        'FEATURE',
        '{}'
    ),
    (
        ...
        '1795008',
        'jpg',
        '/opt/crg/specializations/7/data/files/photo3.jpg',
        'image/jpeg',
        'FEATURE',
        '{}'
    ),
    (
        ...
        '1834311',
        'jpg',
        '/opt/crg/specializations/7/data/files/photo4.jpg',
        'image/jpeg',
        'FEATURE',
        '{}'
    ),
    (
        ...
        '1928509',
        'jpg',
        '/opt/crg/specializations/7/data/files/photo5.jpg',
        'image/jpeg',
        'FEATURE',
        '{}'
    )
