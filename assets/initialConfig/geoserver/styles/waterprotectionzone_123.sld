...
<StyledLayerDescriptor
	...
	<NamedLayer>
		<se:Name>Водоохранные зоны</se:Name>
		<UserStyle>
			<se:Name>WaterProtectionZone_123</se:Name>
			<se:FeatureTypeStyle>
				<se:Rule>
					<se:Name>60301110101</se:Name>
					<se:Description>
						<se:Title>Водоохранная зона существующая</se:Title>
					</se:Description>
					<ogc:Filter
						xmlns:ogc="http://www.opengis.net/ogc">
				...
				<se:Rule>
					<se:Name>60301110102</se:Name>
					<se:Description>
						<se:Title>Водоохранная зона планируемая к размещению</se:Title>
					</se:Description>
					<ogc:Filter
						xmlns:ogc="http://www.opengis.net/ogc">
						<ogc:PropertyIsEqualTo>
							<ogc:PropertyName>ruleid</ogc:PropertyName>
							<ogc:Literal>60301110102</ogc:Literal>
						</ogc:PropertyIsEqualTo>
					</ogc:Filter>
					<se:PolygonSymbolizer>
						<se:Fill>
					...
					<se:PolygonSymbolizer>
						<se:Stroke>
							<se:SvgParameter name="stroke">#004b96</se:SvgParameter>
							<se:SvgParameter name="stroke-width">0.8</se:SvgParameter>
							<se:SvgParameter name="stroke-linejoin">mitre</se:SvgParameter>
							<se:SvgParameter name="stroke-linecap">butt</se:SvgParameter>
							<se:SvgParameter name="stroke-dasharray">18 7</se:SvgParameter>
