...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld"
  ...
  <NamedLayer>
    <se:Name>telecomline_topo_500</se:Name>
    <UserStyle>
      <se:Name>telecomline_topo_500</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>1</se:Name>
          <se:Description>
            <se:Title>Линии связи и технических средств управления</se:Title>
          </se:Description>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#3330FF</se:SvgParameter>
              ...
              <se:GraphicStroke>
                <se:Graphic>
                  <se:Mark>
                    ...
                    <se:Fill>
                      <se:SvgParameter name="fill">#3330FF</se:SvgParameter>
                    </se:Fill>
                    <se:Stroke>
                      <se:SvgParameter name="stroke">#3330FF</se:SvgParameter>
        ...
        <se:Rule>
          <se:Name>2</se:Name>
          <se:Description>
            <se:Title>Телефонная канализация</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>classid</ogc:PropertyName>
