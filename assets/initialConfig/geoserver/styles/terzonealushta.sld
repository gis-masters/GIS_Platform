...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld"
  ...
  <NamedLayer>
    <se:Name>terzonealushta</se:Name>
    <UserStyle>
      <se:Name>TZ</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Зона особо-охраняемых природных территорий</se:Title>
          </se:Description>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:GraphicFill>
                <se:Graphic>
                  <se:Mark>
                    <se:WellKnownName>wkt://MULTILINESTRING((-0.008239746093750036 -0.24581833766323768,-0.009613037109374998 0.04943847042773086),(-0.177 0.04999999999999716,-0.008 -0.11700000000000443,0.14282226562500003 0.04999999999999716),(-0.2320861816406252 0.10025019298900872,-0.21423339843750014 0.1167296555772026,-0.19500732421875017 0.12908924625577356,-0.17715454101562514 0.13732897007314193,-0.1579284667968751 0.14419540442527534,-0.13732910156250017 0.14831526404883277,-0.11672973632812494 0.15243512290550143,-0.08377075195312506 0.1565549809740645,-0.03570556640625007 0.1606748382331773,-0.01510620117187511 0.1606748382331773,0.008239746093750036 0.15930155257140655,0.04119873046874992 0.1538084090169889,0.06179809570312488 0.1510618367064751,0.08651733398437499 0.14694197759180838,0.10986328124999988 0.14144883092741622,0.133209228515625 0.13320910850882228,0.15106201171875006 0.1277159586887251,0.17028808593750003 0.1167296555772026,0.18814086914062483 0.10574334817385989))</se:WellKnownName>
                    <se:Stroke>
                      <se:SvgParameter name="stroke">#54a854</se:SvgParameter>
                    </se:Stroke>
                  </se:Mark>
                  <se:Size>25</se:Size>
                </se:Graphic>
            ...
            <se:VendorOption name="random-tile-size">35</se:VendorOption>
          ...
          <se:PolygonSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#2c800b</se:SvgParameter>
        ...
        <se:Rule>
          <se:Name>1065500000</se:Name>
          <se:Description>
            <se:Title>Зона административно-хозяйственных объектов</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
              <ogc:Literal>0655</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#C4A3CE</se:SvgParameter>
            </se:Fill>
          </se:PolygonSymbolizer>
          <se:PolygonSymbolizer>
            <se:Stroke>
        ...
        <se:Rule>
          <se:Name>1065600000</se:Name>
          <se:Description>
            <se:Title>Зоны объектов туристско-делового назначения</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
              <ogc:Literal>0656</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#EC81AB</se:SvgParameter>
            </se:Fill>
          </se:PolygonSymbolizer>
          <se:PolygonSymbolizer>
            <se:Stroke>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Производственная и коммунально-складская зона</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>1065800000</se:Name>
          <se:Description>
            <se:Title>Зона санитарно-защитного озеленения</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Зона садово-дачной застройки</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Зона сельскохозяйственных угодий</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Зоны объектов спортивного назначения</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Зоны объектов туристско-рекреационного назначения</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Зона застройки индивидуальными жилыми домами, малоэтажными многоквартирными жилыми домами</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Зона застройки многоэтажными и среднеэтажными жилыми домами</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Зона объектов отдыха и рекреации, озеленения общего пользования</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Зона лесов и естественных природных ландшафтов</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Зона объектов санаторно-курортного назначения</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Зона земель лесного фонда</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Зона объектов санаторно-туристского назначения</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#73C8FF</se:SvgParameter>
            </se:Fill>
          </se:PolygonSymbolizer>
          <se:PolygonSymbolizer>
            <se:Stroke>
