...
<StyledLayerDescriptor
	...
	<NamedLayer>
		...
		<UserStyle>
			<se:Name>engprotectionzone_698</se:Name>
			<se:FeatureTypeStyle>
				<se:Rule>
					<se:Name>60301050101</se:Name>
					<se:Description>
						<se:Title>Охранная зона нефтепроводов, нефтепродуктопроводов, и аммиакопроводов существующая </se:Title>
					</se:Description>
					<ogc:Filter
						xmlns:ogc="http://www.opengis.net/ogc">
					...
					<se:PolygonSymbolizer>
						<se:Fill>
							<se:SvgParameter name="fill">#703838</se:SvgParameter>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>Охранная зона нефтепроводов, нефтепродуктопроводов, и аммиакопроводов планируемая к размещению</se:Title>
					</se:Description>
					<ogc:Filter
						xmlns:ogc="http://www.opengis.net/ogc">
						<ogc:PropertyIsEqualTo>
					...
					<se:PolygonSymbolizer>
						<se:Stroke>
							...
							<se:SvgParameter name="stroke-dasharray">30.2 7.5</se:SvgParameter>
						</se:Stroke>
					</se:PolygonSymbolizer>
				</se:Rule>
				<se:Rule>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>Охранная зона объектов электроэнергетики, обьектов электросетевого хозяйства и обьектов по производству электрической энергии (вдоль линий электропередачи, вокруг подстанций) существующая</se:Title>
					</se:Description>
					<ogc:Filter
						xmlns:ogc="http://www.opengis.net/ogc">
						<ogc:PropertyIsEqualTo>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>Охранная зона объектов электроэнергетики, обьектов электросетевого хозяйства и обьектов по производству электрической энергии (вдоль линий электропередачи, вокруг подстанций) планируемая к размещению</se:Title>
					</se:Description>
					<ogc:Filter
						xmlns:ogc="http://www.opengis.net/ogc">
						<ogc:PropertyIsEqualTo>
