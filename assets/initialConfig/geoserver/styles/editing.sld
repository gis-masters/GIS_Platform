...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc"
    ...
    <NamedLayer>
        <se:Name>editing</se:Name>
        <UserStyle>
            <se:Name>editing</se:Name>
            <se:FeatureTypeStyle>
                <se:Rule>
                    <se:Name>65030000001</se:Name>
                    <se:Description>
                        <se:Title>Отказано</se:Title>
                    </se:Description>
                    <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
                        <ogc:PropertyIsEqualTo>
                            <ogc:PropertyName>result</ogc:PropertyName>
                            <ogc:Literal>65030000001</ogc:Literal>
                        </ogc:PropertyIsEqualTo>
                    </ogc:Filter>
                ...
                <se:Rule>
                    <se:Name>66030000001</se:Name>
                    <se:Description>
                        <se:Title>Согласовано</se:Title>
                    </se:Description>
                    <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
                        <ogc:PropertyIsEqualTo>
                            <ogc:PropertyName>result</ogc:PropertyName>
                            <ogc:Literal>66030000001</ogc:Literal>
                        </ogc:PropertyIsEqualTo>
                    </ogc:Filter>
                    <se:PolygonSymbolizer>
                        <se:Fill>
                ...
                <se:Rule>
                    ...
                    <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
                        <ogc:PropertyIsEqualTo>
                            <ogc:PropertyName>result</ogc:PropertyName>
                            <ogc:Literal>67030000001</ogc:Literal>
                        </ogc:PropertyIsEqualTo>
                    </ogc:Filter>
                    <se:PolygonSymbolizer>
                        <se:Fill>
