...
<StyledLayerDescriptor
	...
	<NamedLayer>
		...
		<UserStyle>
			<se:Name>hydraulicstructures_698</se:Name>
			<se:FeatureTypeStyle>
				<se:Rule>
				...
				<se:Rule>
					<se:Name>60204170801</se:Name>
					<se:Description>
						<se:Title>Мелиоративный объект существующие и строящийся</se:Title>
					</se:Description>
					<ogc:Filter
						xmlns:ogc="http://www.opengis.net/ogc">
						<ogc:PropertyIsEqualTo>
							<ogc:PropertyName>ruleid</ogc:PropertyName>
							<ogc:Literal>60204170801</ogc:Literal>
						</ogc:PropertyIsEqualTo>
					</ogc:Filter>
					<se:LineSymbolizer>
						<se:Stroke>
				...
				<se:Rule>
					...
					<ogc:Filter
						...
						<ogc:PropertyIsEqualTo>
							<ogc:PropertyName>ruleid</ogc:PropertyName>
							<ogc:Literal>60204170802</ogc:Literal>
						</ogc:PropertyIsEqualTo>
					</ogc:Filter>
					...
					<se:LineSymbolizer>
						<se:Stroke>
							...
							<se:SvgParameter name="stroke-linejoin">mitre</se:SvgParameter>
							<se:SvgParameter name="stroke-linecap">butt</se:SvgParameter>
							<se:SvgParameter name="stroke-dasharray">26 5.7</se:SvgParameter>
						</se:Stroke>
					</se:LineSymbolizer>
				</se:Rule>
				<se:Rule>
					<se:Name>60204170803</se:Name>
					<se:Description>
					...
					<ogc:Filter
						...
						<ogc:PropertyIsEqualTo>
							<ogc:PropertyName>ruleid</ogc:PropertyName>
							<ogc:Literal>60204170803</ogc:Literal>
						</ogc:PropertyIsEqualTo>
					</ogc:Filter>
					<se:PolygonSymbolizer>
                        <se:Fill>
