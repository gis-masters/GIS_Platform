...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld"
  ...
  <NamedLayer>
    <se:Name>sewerpipeline_topo_500</se:Name>
    <UserStyle>
      <se:Name>sewerpipeline_topo_500</se:Name>
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          <se:Name>1</se:Name>
          <se:Description>
            <se:Title>Канализация (без подразделений)</se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name>2</se:Name>
          <se:Description>
            <se:Title>Канализация бытовая</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>classid</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>3</se:Name>
          <se:Description>
            <se:Title>Канализация дренажная</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>classid</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>4</se:Name>
          <se:Description>
            <se:Title>Канализация ливневая</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>classid</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>5</se:Name>
          <se:Description>
            <se:Title>Канализация напорная</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>classid</ogc:PropertyName>
