    ...
    <UserStyle>
      ...
      <se:Rule>
        ...
        <se:Rule>
          <se:Name>2</se:Name>
          <se:Description>
            <se:Title>Не выполнялось</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>state</ogc:PropertyName>
		...
		<se:Rule>
          <se:Name>3</se:Name>
          <se:Description>
            <se:Title>Загружены растровые ПЗЗ</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>state</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>4</se:Name>
          <se:Description>
            <se:Title>Данные устарели</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>state</ogc:PropertyName>
