    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Магистральная дорога скоростного движения существующая</se:Title>
          </se:Description>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Магистральная улица общегородского значения непрерывного движения существующая</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
