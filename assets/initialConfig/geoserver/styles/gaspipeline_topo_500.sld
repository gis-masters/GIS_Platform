...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld"
  ...
  <NamedLayer>
    <se:Name>gaspipeline_topo_500</se:Name>
    <UserStyle>
      <se:Name>gaspipeline_topo_500</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#42FF8A</se:SvgParameter>
              ...
              <se:GraphicStroke>
                <se:Graphic>
                  <se:Mark>
                    ...
                    <se:Fill>
                      <se:SvgParameter name="fill">#42FF8A</se:SvgParameter>
                    </se:Fill>
                  </se:Mark>
                  <se:Size>8</se:Size>
                </se:Graphic>
