		...
		<UserStyle>
			...
			<se:FeatureTypeStyle>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>Нефтепродуктопровод существующий</se:Title>
					</se:Description>
					<ogc:Filter
						xmlns:ogc="http://www.opengis.net/ogc">
						<ogc:PropertyIsEqualTo>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>Нефтепродуктопровод планируемый к размещению</se:Title>
					</se:Description>
					<ogc:Filter
						xmlns:ogc="http://www.opengis.net/ogc">
						<ogc:PropertyIsEqualTo>
				...
				<se:Rule>
					...
					<se:Description>
						<se:Title>Нефтепродуктопровод планируемый к реконструкции</se:Title>
					</se:Description>
					<ogc:Filter
						xmlns:ogc="http://www.opengis.net/ogc">
						<ogc:PropertyIsEqualTo>
