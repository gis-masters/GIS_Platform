...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Зоны с особыми условиями использования территорий</se:Name>
          <se:Description>
            <se:Title>Зоны с особыми условиями использования территорий</se:Title>
          </se:Description>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#00FF21</se:SvgParameter>
              <se:SvgParameter name="fill-opacity">0.6</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
              <se:SvgParameter name="stroke">#007F0E</se:SvgParameter>
