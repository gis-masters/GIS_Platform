...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld"
  ...
  <NamedLayer>
    <se:Name>undeveloped_lease</se:Name>
    <UserStyle>
      <se:Name>undeveloped_lease</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Неосвоенная аренда</se:Name>
          <se:Description>
            <se:Title>Неосвоенная аренда</se:Title>
          </se:Description>


          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#A9FDA9</se:SvgParameter>
              <se:SvgParameter name="fill-opacity">0.8</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
              <se:SvgParameter name="stroke">#d65306</se:SvgParameter>
