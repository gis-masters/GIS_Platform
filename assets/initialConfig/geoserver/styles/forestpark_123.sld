...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:se="http://www.opengis.net/se" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" version="1.1.0" xmlns:ogc="http://www.opengis.net/ogc">
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>ForestPark_123</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>70502010001</se:Name>
          <se:Description>
            <se:Title>Лесопарковый зеленый пояс существующий</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
              <ogc:Literal>70502010001</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
              ...
              <se:GraphicFill>
                <se:Graphic>
                  <se:Mark>
                    ...
                    <se:Stroke>
                      <se:SvgParameter name="stroke">#8dad8a</se:SvgParameter>
        ...
        <se:Rule>
          <se:Name>70502010002</se:Name>
          <se:Description>
            <se:Title>Лесопарковый зеленый пояс планируемый к размещению</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>ruleid</ogc:PropertyName>
              <ogc:Literal>70502010002</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
