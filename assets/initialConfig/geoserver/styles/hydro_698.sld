  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
        <se:Name>70602050001</se:Name>
					<se:Description>
						<se:Title>Природный выход подземных вод (родник, гейзер)</se:Title>
					</se:Description>
					<ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
						<ogc:PropertyIsEqualTo>
							<ogc:PropertyName>ruleid</ogc:PropertyName>
							<ogc:Literal>70602050001</ogc:Literal>
						</ogc:PropertyIsEqualTo>
					</ogc:Filter>
					<se:PointSymbolizer>
						<se:Graphic>
							<se:ExternalGraphic>
								<se:OnlineResource xlink:type="simple" xlink:href="svg_698/13_Hydro/70602050001.svg" />
        ...
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
            ...
            <se:VendorOption name="random-symbol-count">3.7</se:VendorOption>
            <se:VendorOption name="random-seed">3.7</se:VendorOption>
          </se:PolygonSymbolizer>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:GraphicFill>
