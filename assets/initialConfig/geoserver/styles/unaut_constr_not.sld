		...
		<UserStyle>
            ...
            <se:Title>Решение о (сносе) / (приведении в соответствие с установленными требованиями) самовольной постройки</se:Title>
					...
					<se:PointSymbolizer>
						<se:Graphic>
							<se:ExternalGraphic>
								<se:OnlineResource xlink:type="simple" xlink:href="icons/demolition.png"/>
            ...
            <se:Title>Исковые заявления в суд о (сносе) / (приведении в соответствие с установленными требованиями) самовольной постройки</se:Title>
					...
					<se:PointSymbolizer>
						<se:Graphic>
							<se:ExternalGraphic>
								<se:OnlineResource xlink:type="simple" xlink:href="icons/unauthorized.png"/>
								<se:Format>image/png</se:Format>
							</se:ExternalGraphic>
							<se:Size>30</se:Size>
						</se:Graphic>
            ...
            <se:Title>Уведомление об отсутствии признаков самовольной постройки</se:Title>
					...
					<se:PointSymbolizer>
						<se:Graphic>
							<se:ExternalGraphic>
								<se:OnlineResource xlink:type="simple" xlink:href="icons/valid.png"/>
								<se:Format>image/png</se:Format>
							</se:ExternalGraphic>
							<se:Size>30</se:Size>
						</se:Graphic>
