...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld"
  ...
  <NamedLayer>
    <se:Name>zone_d</se:Name>
    <UserStyle>
      <se:Name>zone_d</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Зона Г</se:Name>
          <se:Description>
            <se:Title>Зона Г</se:Title>
          </se:Description>
          <se:ElseFilter/>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#BA5EE5</se:SvgParameter>
              <se:SvgParameter name="fill-opacity">0.6</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
              <se:SvgParameter name="stroke">#6618E2</se:SvgParameter>
