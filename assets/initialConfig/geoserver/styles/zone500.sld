...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld"
  ...
  <NamedLayer>
    <se:Name>zone500</se:Name>
    <UserStyle>
      <se:Name>zone500</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Пятисотметровая зона</se:Name>
          <se:Description>
            <se:Title>Пятисотметровая зона</se:Title>
          </se:Description>
          <se:ElseFilter/>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#0026FF</se:SvgParameter>
              <se:SvgParameter name="fill-opacity">0.6</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
              <se:SvgParameter name="stroke">#0026FF</se:SvgParameter>
