...
<StyledLayerDescriptor
	...
	<NamedLayer>
		...
		<UserStyle>
         <se:Name>heritagearea_698</se:Name>
			<se:FeatureTypeStyle>
				<se:Rule>
					<se:Name>604010201</se:Name>
					<se:Description>
					...
					<ogc:Filter
						...
						<ogc:PropertyIsEqualTo>
							...
							<ogc:Literal>604010201</ogc:Literal>
						</ogc:PropertyIsEqualTo>
					</ogc:Filter>
					...
					<se:PolygonSymbolizer>
						<se:Stroke>
							...
							<se:SvgParameter name="stroke-dasharray">3 7</se:SvgParameter>
						</se:Stroke>
						<se:PerpendicularOffset>-2</se:PerpendicularOffset>
					</se:PolygonSymbolizer>
				</se:Rule>
				<se:Rule>
					<se:Name>604010202</se:Name>
					<se:Description>
					...
					<ogc:Filter
						...
						<ogc:PropertyIsEqualTo>
							<ogc:PropertyName>ruleid</ogc:PropertyName>
							<ogc:Literal>604010202</ogc:Literal>
						</ogc:PropertyIsEqualTo>
					</ogc:Filter>
					<se:PolygonSymbolizer>
						<se:Fill>
					...
					<se:PolygonSymbolizer>
						<se:Stroke>
							...
							<se:SvgParameter name="stroke-dasharray">1.1 5</se:SvgParameter>
						</se:Stroke>
						<se:PerpendicularOffset>2</se:PerpendicularOffset>
					</se:PolygonSymbolizer>
				</se:Rule>
				<se:Rule>
					...
					<se:PolygonSymbolizer>
						<se:Fill>
							<se:SvgParameter name="fill">#aa66cd </se:SvgParameter>
						</se:Fill>
						<se:Stroke>
