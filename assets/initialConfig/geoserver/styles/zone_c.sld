...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld"
  ...
  <NamedLayer>
    <se:Name>zone_c</se:Name>
    <UserStyle>
      <se:Name>zone_c</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Зона В</se:Name>
          <se:Description>
            <se:Title>Зона В</se:Title>
          </se:Description>
          <se:ElseFilter/>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#FF01F7</se:SvgParameter>
              <se:SvgParameter name="fill-opacity">0.6</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
              <se:SvgParameter name="stroke">#E80A53</se:SvgParameter>
