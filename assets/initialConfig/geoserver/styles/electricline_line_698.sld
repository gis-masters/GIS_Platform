...
<StyledLayerDescriptor
	...
	<NamedLayer>
		...
		<UserStyle>
			<se:Name>ElectricLine_698</se:Name>
			<se:FeatureTypeStyle>
				<se:Rule>
				...
				<se:Rule>
					<se:Name>60204031801</se:Name>
					<se:Description>
						<se:Title>Линии электропередачи 0,4кВ существующие</se:Title>
					</se:Description>
					<ogc:Filter
						xmlns:ogc="http://www.opengis.net/ogc">
						<ogc:PropertyIsEqualTo>
							<ogc:PropertyName>ruleid</ogc:PropertyName>
							<ogc:Literal>60204031801</ogc:Literal>
						</ogc:PropertyIsEqualTo>
					</ogc:Filter>
					<se:LineSymbolizer>
						<se:Stroke>
				...
				<se:Rule>
					<se:Name>60204031802</se:Name>
					<se:Description>
						<se:Title>Линии электропередачи 0,4 кВ планируемые к размещению</se:Title>
					</se:Description>
					<ogc:Filter
						xmlns:ogc="http://www.opengis.net/ogc">
						<ogc:PropertyIsEqualTo>
							<ogc:PropertyName>ruleid</ogc:PropertyName>
							<ogc:Literal>60204031802</ogc:Literal>
						</ogc:PropertyIsEqualTo>
					</ogc:Filter>
					<se:LineSymbolizer>
						<se:Stroke>
				...
				<se:Rule>
					<se:Name>60204031803</se:Name>
					<se:Description>
						<se:Title>Линии электропередачи 0,4 кВ планируемые к реконструкции</se:Title>
					</se:Description>
					<ogc:Filter
						xmlns:ogc="http://www.opengis.net/ogc">
						<ogc:PropertyIsEqualTo>
							<ogc:PropertyName>ruleid</ogc:PropertyName>
							<ogc:Literal>60204031803</ogc:Literal>
						</ogc:PropertyIsEqualTo>
					</ogc:Filter>
					<se:LineSymbolizer>
						<se:Stroke>
				...
				<se:Rule>
					<se:Name>60204031804</se:Name>
					<se:Description>
						<se:Title>Линии электропередачи 0,4 кВ планируемые к ликвидации</se:Title>
					</se:Description>
					<ogc:Filter
						xmlns:ogc="http://www.opengis.net/ogc">
						<ogc:PropertyIsEqualTo>
							<ogc:PropertyName>ruleid</ogc:PropertyName>
							<ogc:Literal>60204031804</ogc:Literal>
						</ogc:PropertyIsEqualTo>
					</ogc:Filter>
					<se:LineSymbolizer>
						<se:Stroke>
