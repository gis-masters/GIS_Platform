package ru.mycrg.data_service.service.smev3.register_rnv;

import org.junit.Test;
import ru.mycrg.data_service.service.smev3.Mnemonic;
import ru.mycrg.data_service.service.smev3.model.ProcessMessageStatus;
import ru.mycrg.data_service.service.smev3.request.register_rnv.RegisterRnvResponseService;
...
public class RegisterRnvResponseTest extends AProcessorTest {
    ...
    public void responseReject() throws Exception {
        ...
        var service = new RegisterRnvResponseService();
        ...
        assertEquals(Mnemonic.REGISTER_RNV_1_0_8, processResult.getXmlBuildMeta().getMnemonic());
