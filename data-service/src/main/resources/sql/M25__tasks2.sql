ALTER TABLE IF EXISTS data.tasks
    ADD COLUMN IF NOT EXISTS inbox_data_key_data_connection character varying;

ALTER TABLE IF EXISTS data.tasks
    ADD COLUMN IF NOT EXISTS data_section_key_data_connection character varying;

UPDATE data.schemas SET class_rule = '{
