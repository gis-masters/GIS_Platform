...
@Configuration
public class EpsgConfig {

    @Bean
    public EpsgCodes epsgCodes() {
        ...
        List<GeometryProjection> geometryProjections = Arrays.asList(epsg314314, epsg314315);

        return new EpsgCodes(geometryProjections);
    }
}
