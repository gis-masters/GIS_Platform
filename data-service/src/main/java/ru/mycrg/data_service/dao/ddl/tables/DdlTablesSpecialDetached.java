...
@Repository
public class DdlTablesSpecialDetached {

    private final Logger log = LoggerFactory.getLogger(DdlTablesSpecialDetached.class);

    private final DdlTablesBaseDetached ddlTablesBaseDetached;

    public DdlTablesSpecialDetached(DdlTablesBaseDetached ddlTablesBaseDetached) {
    ...
    public void create(JdbcTemplate jdbcTemplate,
        ...
        ddlTablesBaseDetached.create(jdbcTemplate, targetSchema, targetTable, properties, PRIMARY_KEY);
    ...
    public boolean isGeometryExist(List<SimplePropertyDto> properties) {
        return properties.stream()
                         .anyMatch(SimplePropertyDto::isGeometry);
    }

    public String getExtensionTableCreateQuery(String targetSchema, String extensionTable) {
    ...
    public void addAdditionalFields(List<SimplePropertyDto> schemaProperties,
