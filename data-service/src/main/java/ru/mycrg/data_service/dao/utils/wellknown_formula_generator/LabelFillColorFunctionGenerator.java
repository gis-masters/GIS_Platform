 ...
 */
@Component
public class LabelFillColorFunctionGenerator implements IWellKnownFormulaGenerator {

    private final Map<String, List<String>> allowedFieldTypes;

    public LabelFillColorFunctionGenerator() {
    ...
    public String generate() {
        return "GENERATED ALWAYS AS (substr(MD5(label), 7, 6)) STORED";
    }
