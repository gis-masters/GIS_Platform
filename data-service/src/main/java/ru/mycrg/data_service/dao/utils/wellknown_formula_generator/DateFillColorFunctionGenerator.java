...
/**
 * Рассчёт цвета заливки по date_stroke_color.
 */
@Component
public class DateFillColorFunctionGenerator implements IWellKnownFormulaGenerator {

    private final Map<String, List<String>> allowedFieldTypes;

    public DateFillColorFunctionGenerator() {
    ...
    public String generate() {
        return "GENERATED ALWAYS AS (substr(MD5(date_part('epoch', COALESCE(photography_time, '1990-01-01'))::text), 7, 6)) STORED";
    }

    @Override
    public String getType() {
        return "date_fill_color";
    }
