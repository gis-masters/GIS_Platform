...
public class GeoserverMigrationHandler {
    ...
    public void handle() {
        ...
        String quotedDbUser = prepareQuoteIdentifier(dbUser);
        ...
        try {
            ...
            String groupRoles = "CREATE TABLE IF NOT EXISTS public.group_roles " +
                    ...
                    ") TABLESPACE pg_default; ALTER TABLE public.group_roles OWNER to " + quotedDbUser;
            ...
            String roleGroups = "CREATE TABLE IF NOT EXISTS public.role_props" +
                    ...
                    ") TABLESPACE pg_default; ALTER TABLE public.role_props OWNER to " + quotedDbUser;

            String roles = "CREATE TABLE IF NOT EXISTS public.roles" +
                    "(name character varying(64) NOT NULL," +
                    " parent character varying(64)," +
                    " CONSTRAINT roles_pkey PRIMARY KEY (name)" +
                    ") TABLESPACE pg_default; ALTER TABLE public.roles OWNER to " + quotedDbUser;
            ...
            String userRoles = "CREATE TABLE IF NOT EXISTS public.user_roles" +
                    ...
                    ") TABLESPACE pg_default; ALTER TABLE public.user_roles OWNER to " + quotedDbUser;
            ...
            String users = "CREATE TABLE IF NOT EXISTS public.users" +
                    ...
                    ") TABLESPACE pg_default; ALTER TABLE public.users OWNER to " + quotedDbUser;
            ...
            String usersProps = "CREATE TABLE IF NOT EXISTS public.user_props" +
                    ...
                    ") TABLESPACE pg_default; ALTER TABLE public.user_props OWNER to " + quotedDbUser;

            String groups = "CREATE TABLE IF NOT EXISTS public.groups" +
                    "(name character varying(128) NOT NULL," +
                    " enabled character(1) NOT NULL," +
                    " CONSTRAINT groups_pkey PRIMARY KEY (name)" +
                    ") TABLESPACE pg_default; ALTER TABLE public.groups OWNER to " + quotedDbUser;
            ...
            String groupMembers = "CREATE TABLE IF NOT EXISTS public.group_members" +
                    ...
                    ") TABLESPACE pg_default; ALTER TABLE public.group_members OWNER to " + quotedDbUser;
