...
import static ru.mycrg.data_service_contract.enums.ValueType.VERSIONS;

@Component
public class SqlParameterSourceMapperVersions implements SqlParameterSourceMapper {

    private final Logger log = LoggerFactory.getLogger(SqlParameterSourceMapperVersions.class);
