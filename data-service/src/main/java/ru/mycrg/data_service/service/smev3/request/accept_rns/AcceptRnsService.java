...
public class AcceptRnsService {
    ...
    public void acceptRnsRequest(String body) throws CrgDaoException, JsonProcessingException {
    ...
    private void createDocumentAndLinkToTask(RequestType request, Map<String, Object> taskContent, Long taskId) throws
        ...
        ResourceQualifier libraryQualifier = libraryQualifier(RNS_LIBRARY_ID);
        ...
        recordContent.put(REQUEST_TYPE_ATTRIBUTE, RNS_REQUEST_TYPE);
        recordContent.put(DATA_TYPE_ATTRIBUTE, RNS_DATA_TYPE);
        recordContent.put(TITLE.getName(), RNS_TITLE);
        recordContent.put(CONTENT_TYPE_ID.getName(), RNS_CONTENT_TYPE);
