...
public class RnvDocumentDataProvider implements IDocumentDataProvider {
    ...
    public <T> String getRegAddress(T requestType) {
        ...
        return ofNullable(request.getRecipientPersonalData()).map(RecipientPersonalDataType::getRegAddress)
                                                             .orElse("");
    }
    ...
    public <T> String getFactAddress(T requestType) {
        ...
        return ofNullable(request.getRecipientPersonalData()).map(RecipientPersonalDataType::getFactAddress)
                                                             .orElse("");
    }
    ...
    public <T> String getPhone(T requestType) {
        ...
        return ofNullable(request.getRecipientPersonalData())
                .map(RecipientPersonalDataType::getPhone)
                .orElse("");
    }
    ...
    public <T> String getEmail(T requestType) {
        ...
        return ofNullable(request.getRecipientPersonalData())
                .map(RecipientPersonalDataType::getEmail)
                .orElse("");
    }
