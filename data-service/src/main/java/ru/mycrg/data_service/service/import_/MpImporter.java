...
public class MpImporter implements Importer<Long> {
    ...
    public Long doImport(MultipartFile file, ResourceQualifier qualifier) {
        ...
        List<SimplePropertyDto> crossedProperties = getCrossedPropertiesFromTwoSchemas(schemaOfCurrentLayer, schema);
        ...
        try {
            Map<String, Object> dataForSavingToDB = xmlParser.parseByScheme(
                    ...
                    schemaOfCurrentLayer.getName().equalsIgnoreCase("zu2"));
            ...
            Map<String, Object> modifiedProps = systemAttributeHandler
                    .init(schema, propertiesMatchingToDBColumns)
                    .excludeAutoGeneratedFields()
                    .build();

            return recordsDao.addRecord(qualifier, new RecordEntity(modifiedProps), schema).getId();
