...
@Component
public class GpzuDuplicateStrategy implements IGpzuRequestDocumentCreator {
    ...
    private static XWPFDocument createTemplate(RequestType request) {
        ...
        addCenterText(document, "о выдаче дубликата градостроительного плана земельного участка", 13, false);
        addText(document, "");
        ...
        addText(document, "");
        addCenterText(document, "2. Сведения о выданном градостроительном плане земельного участка", 13, false);
