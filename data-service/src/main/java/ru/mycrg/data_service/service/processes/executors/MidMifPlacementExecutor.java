...
public class MidMifPlacementExecutor implements IExecutor<ImportReport>, IFilePlacer {
    ...
    private final String DEFAULT_MID_MIF_STYLE = "generic";
    ...
    public ImportReport execute() {
        ...
        messageBus.produce(
                new PlaceMidFileEvent(authenticationFacade.getAccessToken(),
                                      this.processModel,
                                      this.wsMsgId,
    ...
    public IExecutor<ImportReport> initialize(Object data) {
        ...
        try {
            ...
            String msg = String.format("Задана некорректная модель Mid/Mif импорта: %s", data);
