...
import static ru.mycrg.data_service_contract.enums.ValueType.INT;

@Component
public class TelegramNotifierInt implements ITelegramNotifier {

    private final ITelegramNotifier telegramNotifier;

    public TelegramNotifierInt(TelegramNotifierString telegramNotifier) {
