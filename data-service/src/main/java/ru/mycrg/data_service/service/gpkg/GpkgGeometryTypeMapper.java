 ...
 * {@link ru.mycrg.data_service_contract.enums.GeometryType}) есть 11 из них, а фронт умеет работать только с тремя из
 * них: {@code POINT}, {@code MULTI_LINE_STRING} и {@code MULTI_POLYGON}.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Если тип геометрии не поддерживается в нашем домене или его невозможно однозначно отнести к одному из трёх базовых
 * типов, метод выбрасывает {@link IllegalArgumentException}.
 * </p>
 * <p>
 * Примеры типов, которые существуют в GPKG, но непосредственно у нас не поддерживаются и, соответственно, не маппятся:
 * {@code GEOMETRY}, {@code GEOMETRYCOLLECTION}, {@code CIRCULARSTRING}, {@code COMPOUNDCURVE}, {@code CURVEPOLYGON},
 * {@code MULTICURVE}, {@code MULTISURFACE}, {@code CURVE}, {@code SURFACE} и др.
 * </p>
 *
