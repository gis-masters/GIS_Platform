Feature: Создание событий аудита
  ...
  Scenario Outline: Создание события аудита с валидными данными
    ...
    Examples:
      ...
      | CURRENT_TIME  | CREATE     | STRING_100 | PROJECT    | 1        | JSON             |
  ...
  Scenario Outline: Создание события аудита c невалидными данными ("<reason>")
    ...
    Examples:
      ...
      | CURRENT_TIME  | CREATE     | STRING_101 | PROJECT    | 555      | JSON             | entityName: значение, длинной более100 символов, не допускается                      |
      ...
      | CURRENT_TIME  | CREATE     | STRING_101 | PROJECT    | 1        | JSON             | entityName: значение, больше 100символов не допускается                              |
