Feature: Регистрация намерений о создании организации
  ...
  Проверка дублирования email непосредственно среди заявок (intents)
    ...
    Given существует заявка на создание новой организации от "fiz5@fiz.ru"
    When  я отправляю заявку на создание новой организации: "fiz5@fiz.ru"
    Then  сервер отвечает со статус-кодом 409
    And   сообщение об ошибке соответствует ожидаемому: "Почта: 'fiz5@fiz.ru' уже занята"
