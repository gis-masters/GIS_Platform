Feature: Влияние на файлы модификаций записи в библиотеке документов.
  ...
  # FIXME: Тест стабильно проходит локально. #780
#   {   Тест не проходит по причине
#       "status": "INTERNAL_SERVER_ERROR",
#       "message": "Shit happens: Не удалось создать растровый слой на геосервере"
#   }
#  Scenario: При модификации записи в библиотеке владельцем организации (а именно удаление из неё файлов) НЕ удаляются слои, связанные с этими файлами на gis-service и на geoserver
