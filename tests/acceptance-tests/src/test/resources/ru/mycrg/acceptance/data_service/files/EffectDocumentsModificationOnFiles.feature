Feature: Влияние на файлы модификаций записи в библиотеке документов.
  ...
  Scenario: При модификации записи в библиотеке владельцем организации (а именно удаление из неё файлов) удаляются так
  же слои, связанные с этими файлами на gis-service и на geoserver
