Feature: Создание слоев в проектах
  ...
  Scenario Outline: Создание слоя проекта c невалидными данными ("<reason>")
    ...
    Examples:
      | title      | styleName    | type     | schemaId     | nativeCRS  | dataSourceUri | libraryId | recordId | reason                          |
      ...
      | STRING_5   | transportobj | raster   | transportobj | STRING_0   | STRING_6      | libraryId | 1        | Пустой nativeCRS (raster)       |
      | STRING_5   | STRING_5     | raster   | transportobj | EPSG:28406 | STRING_6      | libraryId |          | Пустое поле recordId            |
      | STRING_5   | STRING_5     | raster   | transportobj | EPSG:28406 | STRING_6      |           | 1        | Пустое поле libraryId           |
