Feature: Проверка импорта данных от АИС УМС
  ...
  Scenario: Импорт валидных данных от АИС УМС
    When Пользователь отправляет запрос с валидными данными,имитирующие данные от АИС УМС "STRING_16" "STRING_16" "STRING_16" "STRING_16" "STRING_16"
