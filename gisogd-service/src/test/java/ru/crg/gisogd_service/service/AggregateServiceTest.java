...
class AggregateServiceTest {
    ...
    void townPlanningRegulationsAggregateTest() {
        Resource resource = new ClassPathResource("event/TownPlanningRegulationsEvent.json");
    ...
    void constructionZonesBordersAggregateTest() {
        Resource eventData = new ClassPathResource("event/ConstructionZonesBordersEvent.json");
    ...
    void indentLineAggregateTest() {
        Resource eventData = new ClassPathResource("event/IndentLineEvent.json");
    ...
    void gpzuInfoP23AggregateTest() {
        Resource eventData = new ClassPathResource("event/GPZUInfoP23Event.json");
    ...
    void gpzuInfoP24AggregateTest() {
        Resource eventData = new ClassPathResource("event/GPZUInfoP24Event.json");
    ...
    void gpzuInfoP25AggregateTest() {
        Resource eventData = new ClassPathResource("event/GPZUInfoP25Event.json");
    ...
    void gpzuInfoP41AggregateTest() {
        Resource eventData = new ClassPathResource("event/GPZUInfoP41Event.json");
