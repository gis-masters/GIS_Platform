...
/**
 * Модель dl_data_section17.
 * @author Vladimir Nomokonov
 */
@CrimeaRelationResolve(nameStartWith = "dl_data_section17", objectClass = DataSection17.class)
public class DataSection17Mixin {
    ...
    @JsonProperty("landplot_connection")
    private String landPlot;
    @JsonProperty("oks_connection")
    private String OKS;
    @JsonProperty("note")
    private String note;
    @JsonProperty("developer_data_connection")
