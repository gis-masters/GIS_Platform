...
/**
 * Модель dl_data_section9.
 * @author Vladimir Nomokonov
 */
@CrimeaRelationResolve(nameStartWith = "dl_data_section9", objectClass = DataSection9.class)
public class DataSection9Mixin {
    ...
    @JsonProperty("note")
    private String note;
    @JsonProperty("artland")
    private List<String> artLand;
