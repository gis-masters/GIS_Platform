...
/**
 * Модель dl_data_section8.
 * @author Vladimir Nomokonov
 */
@CrimeaRelationResolve(nameStartWith = "dl_data_section8", objectClass = DataSection8.class)
public class DataSection8Mixin {
    ...
    @JsonProperty("engineerorg")
    private String engineerOrg;
    @JsonProperty("note")
    private String note;
    @JsonProperty("researchType_fake")
