...
/**
 * Модель данных Document - DataSection2.
 * @author Vladimir Nomokonov
 */
@CrimeaRelationResolve(nameStartWith = "dl_data_section2", objectClass = DataSection2.class)
public class DataSection2Mixin {
    ...
    @JsonProperty("guidDocPreviousVersion")
