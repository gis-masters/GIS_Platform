...
/**
 * Модель данных Document - DataSection14.
 * @author Vladimir Nomokonov
 */
@CrimeaRelationResolve(nameStartWith = "dl_data_section14", objectClass = DataSection14.class)
public class DataSection14Mixin {
