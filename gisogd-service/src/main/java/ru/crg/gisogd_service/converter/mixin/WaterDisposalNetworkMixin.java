...
/**
 * Модель данных из water_disposal_network.
 * @author Vladimir Nomokonov
 */
@CrimeaRelationResolve(nameStartWith = "water_disposal_network", objectClass = WaterDisposalNetwork.class)
public class WaterDisposalNetworkMixin {

    @JsonProperty("guid_water_disposal_network")
    private String guid;
    @JsonProperty("class")
