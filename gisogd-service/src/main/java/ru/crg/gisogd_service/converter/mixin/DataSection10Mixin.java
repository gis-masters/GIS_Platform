...
/**
 * Модель dl_data_section10.
 * @author Vladimir Nomokonov
 */
@CrimeaRelationResolve(nameStartWith = "dl_data_section10", objectClass = DataSection10.class)
public class DataSection10Mixin {
    ...
    @JsonProperty("note")
    private String note;
    @ReverseMapping("specialzone")
    private List<String> specialZone;
