...
/**
 * Модель dl_data_section5.
 * @author Vladimir Nomokonov
 */
@CrimeaRelationResolve(nameStartWith = "dl_data_section5", objectClass = DataSection5.class)
public class DataSection5Mixin {
    ...
    @JsonProperty("note")
    private String note;
    @ReverseMapping("dl_data_town_planning_regulations_data_connection")
    private List<String> townPlanningRegulations;
}
