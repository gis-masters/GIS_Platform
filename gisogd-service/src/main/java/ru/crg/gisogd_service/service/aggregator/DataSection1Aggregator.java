...
/**
 * DataSection1 aggregator
 * @author Vladimir Nomokonov
 */
@Component
@AllArgsConstructor
public class DataSection1Aggregator implements CrimeaAggregator<DataSection1> {

    private final EventRepositoryService repositoryService;

    @Override
    public DataSection1 aggregate(DataSection1 crimeaObject, PublishToGisogdRfEvent event) throws JsonProcessingException {
        ...
        crimeaObject.setGuidDocPreviousVersion(repositoryService.findAllGuidsByRef("guid_doc_previous_version", event));
