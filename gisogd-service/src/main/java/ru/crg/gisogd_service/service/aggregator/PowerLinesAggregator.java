...
/**
 * PowerLines aggregator
 * @author Vladimir Nomokonov
 */
@Component
@AllArgsConstructor
public class PowerLinesAggregator implements CrimeaAggregator<PowerLines> {

    private final EventRepositoryService repositoryService;

    @Override
    public PowerLines aggregate(PowerLines crimeaObject, PublishToGisogdRfEvent event) throws JsonProcessingException {
