...
/**
 * DataSection12 aggregator
 * @author Vladimir Nomokonov
 */
@Component
@AllArgsConstructor
public class DataSection12Aggregator implements CrimeaAggregator<DataSection12> {

    private final EventRepositoryService repositoryService;

    @Override
    public DataSection12 aggregate(DataSection12 crimeaObject, PublishToGisogdRfEvent event) throws JsonProcessingException {
