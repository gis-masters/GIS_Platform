...
/**
 * HeatSupplyObject aggregator
 * @author Vladimir Nomokonov
 */
@Component
@AllArgsConstructor
public class HeatSupplyObjectAggregator implements CrimeaAggregator<HeatSupplyObject> {

    private final EventRepositoryService repositoryService;

    @Override
    public HeatSupplyObject aggregate(HeatSupplyObject crimeaObject, PublishToGisogdRfEvent event) throws JsonProcessingException {
