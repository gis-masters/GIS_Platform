...
/**
 * DataSection18 aggregator
 * @author Vladimir Nomokonov
 */
@Component
@AllArgsConstructor
public class DataSection18Aggregator implements CrimeaAggregator<DataSection18> {

    private final EventRepositoryService repositoryService;

    @Override
    public DataSection18 aggregate(DataSection18 crimeaObject, PublishToGisogdRfEvent event) throws JsonProcessingException {
