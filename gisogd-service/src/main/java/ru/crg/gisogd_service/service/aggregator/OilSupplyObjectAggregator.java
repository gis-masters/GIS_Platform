...
/**
 * OilSupplyObject aggregator
 * @author Vladimir Nomokonov
 */
@Component
@AllArgsConstructor
public class OilSupplyObjectAggregator implements CrimeaAggregator<OilSupplyObject> {

    private final EventRepositoryService repositoryService;

    @Override
    public OilSupplyObject aggregate(OilSupplyObject crimeaObject, PublishToGisogdRfEvent event) throws JsonProcessingException {
