...
/**
 * WaterDisposalNetwork aggregator
 * @author Vladimir Nomokonov
 */
@Component
@AllArgsConstructor
public class WaterDisposalNetworkAggregator implements CrimeaAggregator<WaterDisposalNetwork> {

    private final EventRepositoryService repositoryService;

    @Override
    public WaterDisposalNetwork aggregate(WaterDisposalNetwork crimeaObject, PublishToGisogdRfEvent event) throws JsonProcessingException {
