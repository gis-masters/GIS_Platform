...
@Component
@AllArgsConstructor
public class UszizsAggregator implements CrimeaAggregator<USZIZS> {

    private final EventRepositoryService repositoryService;

    @Override
    public USZIZS aggregate(USZIZS crimeaObject, PublishToGisogdRfEvent event) throws JsonProcessingException {
