...
/**
 * DataSection3 aggregator
 * @author Vladimir Nomokonov
 */
@Component
@AllArgsConstructor
public class DataSection3Aggregator implements CrimeaAggregator<DataSection3> {

    private final EventRepositoryService repositoryService;

    @Override
    public DataSection3 aggregate(DataSection3 crimeaObject, PublishToGisogdRfEvent event) throws JsonProcessingException {
