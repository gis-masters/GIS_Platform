...
/**
 * WaterDisposalObject aggregator
 * @author Vladimir Nomokonov
 */
@Component
@AllArgsConstructor
public class WaterDisposalObjectAggregator implements CrimeaAggregator<WaterDisposalObject> {

    private final EventRepositoryService repositoryService;

    @Override
    public WaterDisposalObject aggregate(WaterDisposalObject crimeaObject, PublishToGisogdRfEvent event) throws JsonProcessingException {
