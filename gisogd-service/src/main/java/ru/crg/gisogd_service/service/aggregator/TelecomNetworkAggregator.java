...
/**
 * TelecomNetwork aggregator
 * @author Vladimir Nomokonov
 */
@Component
@AllArgsConstructor
public class TelecomNetworkAggregator implements CrimeaAggregator<TelecomNetwork> {

    private final EventRepositoryService repositoryService;

    @Override
    public TelecomNetwork aggregate(TelecomNetwork crimeaObject, PublishToGisogdRfEvent event) throws JsonProcessingException {
