...
/**
 * DataSection2 aggregator
 * @author Vladimir Nomokonov
 */
@Component
@AllArgsConstructor
public class DataSection2Aggregator implements CrimeaAggregator<DataSection2> {

    private final EventRepositoryService repositoryService;

    @Override
    public DataSection2 aggregate(DataSection2 crimeaObject, PublishToGisogdRfEvent event) throws JsonProcessingException {
