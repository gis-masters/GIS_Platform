...
/**
 * WaterSupplyNetwork aggregator
 * @author Vladimir Nomokonov
 */
@Component
@AllArgsConstructor
public class WaterSupplyNetworkAggregator implements CrimeaAggregator<WaterSupplyNetwork> {

    private final EventRepositoryService repositoryService;

    @Override
    public WaterSupplyNetwork aggregate(WaterSupplyNetwork crimeaObject, PublishToGisogdRfEvent event) throws JsonProcessingException {
