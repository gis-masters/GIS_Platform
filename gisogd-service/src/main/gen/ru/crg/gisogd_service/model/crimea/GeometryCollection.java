 ...
 */
@JsonPropertyOrder({
  GeometryCollection.JSON_PROPERTY_BBOX,
  GeometryCollection.JSON_PROPERTY_CRS,
  GeometryCollection.JSON_PROPERTY_GEOMETRIES,
  GeometryCollection.JSON_PROPERTY_SRS
})
...
public class GeometryCollection extends GeoJsonObject {
  ...
  public GeometryCollection bbox(List<Double> bbox) {
    
    this.bbox = bbox;
    return this;
  }

  public GeometryCollection addBboxItem(Double bboxItem) {
    if (this.bbox == null) {
  ...
  **/
  ...
  public GeometryCollection crs(Crs crs) {
  ...
  **/
  ...
  public GeometryCollection geometries(List<GeoJsonObject> geometries) {
    
    this.geometries = geometries;
    return this;
  }

  public GeometryCollection addGeometriesItem(GeoJsonObject geometriesItem) {
  ...
  **/
  ...
  public GeometryCollection srs(String srs) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bbox, geometryCollection.bbox) &&
        Objects.equals(this.crs, geometryCollection.crs) &&
        Objects.equals(this.geometries, geometryCollection.geometries) &&
        Objects.equals(this.srs, geometryCollection.srs) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bbox, crs, geometries, srs, super.hashCode());
  }
