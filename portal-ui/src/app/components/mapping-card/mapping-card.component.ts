import { Component, Input, type OnChanges, type OnDestroy, type OnInit, type SimpleChanges } from '@angular/core';
import { NGXLogger } from 'ngx-logger';
import { Subject } from 'rxjs';

import { type OldPropertySchema, type OldSchema, ValueType } from '../../services/data/schema/schemaOld.models';
import {
  IMPORT_LAYER_AS_IS,
  type ImportLayerItem,
  NOT_IMPORT_LAYER
} from '../../services/geoserver/import/import.models';
import {
  ImportDataHolderService,
  type InputDataMetrics
} from '../../services/geoserver/import/import-data-holder.service';
import { AS_IS, NOT_IMPORT } from '../../services/models';
