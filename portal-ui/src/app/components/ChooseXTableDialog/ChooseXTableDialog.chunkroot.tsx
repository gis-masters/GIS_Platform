...
import { type Breakpoint, Dialog, DialogActions, DialogContent } from '@mui/material';
...
import './Content/ChooseXTableDialog-Content.scss';
import './Table/ChooseXTableDialog-Table.scss';
