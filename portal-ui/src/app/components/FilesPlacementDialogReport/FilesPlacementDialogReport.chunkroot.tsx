...
import { type FilesPlacementReportStore } from '../FilesPlacementDialog/FilesPlacementDialog.store';

import './FilesPlacementDialogReport.scss';
import './List/FilesPlacementDialogReport-List.scss';
