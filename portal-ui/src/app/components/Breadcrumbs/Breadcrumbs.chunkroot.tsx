import React, { Component, createRef, type CSSProperties, Fragment, type ReactNode, type RefObject } from 'react';
...
import './ShowMoreMenu/Breadcrumbs-ShowMoreMenu.scss';
import './ShowMoreMenuRoot/Breadcrumbs-ShowMoreMenuRoot.scss';
