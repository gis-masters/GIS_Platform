...
import { Checkbox, Divider, ListItemText, MenuItem, Select, type SelectChangeEvent } from '@mui/material';
...
import './XTable-Filter_type_userId.scss';
...
@observer
class XTableFilterTypeUser extends Component<XTableFilterProps> {
...
export const withTypeUser = withBemMod<XTableFilterProps, XTableFilterProps>(
  cnXTableFilter(),
  { type: PropertyType.USER },
  () => XTableFilterTypeUser
);
