...
const cnTasksJournalSettings = cn('TasksJournal', 'Settings');

interface TasksJournalSettingsProps {
...
@observer
export class TasksJournalSettings extends Component<TasksJournalSettingsProps> {
  @observable private dialogOpen = false;

  constructor(props: TasksJournalSettingsProps) {
    super(props);
    makeObservable(this);
  }
    ...
    return (
      <>
        <Tooltip title='Настроить столбцы'>
          <IconButton className={cnTasksJournalSettings()} onClick={this.openDialog}>
