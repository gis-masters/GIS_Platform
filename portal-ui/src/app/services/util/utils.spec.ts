...
function functionalZoneCustomRule(obj) {
  ...
  if (
    !(
      obj.classid == 701010100 ||
      obj.classid == 701010101 ||
      obj.classid == 701010102 ||
      obj.classid == 701010103 ||
      obj.classid == 701010104 ||
      obj.classid == 701010200 ||
      obj.classid == 701010300 ||
      obj.classid == 701010301 ||
      obj.classid == 701010302 ||
      obj.classid == 701010303
    )
  ) {
    if (obj.pop_den) {
