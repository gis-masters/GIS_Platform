declare namespace CAPICOM {
  type StoreLocationPluginNames = 'CAPICOM_LOCAL_MACHINE_STORE' | 'CAPICOM_CURRENT_USER_STORE';
  ...
  type CertIntoTypePluginNames = 'CAPICOM_CERT_INFO_SUBJECT_SIMPLE_NAME' | 'CAPICOM_CERT_INFO_ISSUER_SIMPLE_NAME';
  ...
  type EKUPluginNames = 'CAPICOM_EKU_OTHER' | 'CAPICOM_EKU_CLIENT_AUTH' | 'CAPICOM_EKU_SMARTCARD_LOGON';
