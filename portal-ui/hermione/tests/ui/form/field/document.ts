...
describe('Форма', () => {
  ...
  describe('Поле document', () => {
     ...
     *   When Пользователь открывает в библиотеке блоков поле document редактируемое
    ...
    it('Внешний вид', async function () {
      ...
      await bl.openExample('form-field-document', 'single-editable');
     ...
     *   When Пользователь открывает в библиотеке блоков поле document редактируемое пустое
     *   Then Поле выглядит как положено
     */
    it('Внешний вид пустого поля', async function () {
      ...
      await bl.openExample('form-field-document', 'single-editable-empty');
      await form.waitForVisible();
     ...
     *   When Пользователь открывает в библиотеке блоков поле document редактируемое множественное
     *   Then Поле выглядит как положено
     */
    it('Внешний вид множественного поля', async function () {
      ...
      await bl.openExample('form-field-document', 'multiple-editable');
      await form.waitForVisible();
    ...
    it('Внешний вид множественного поля с переполнением', async function () {
      ...
      await bl.openExample('form-field-document', 'multiple-editable-scroll');
      await form.waitForVisible();
    ...
    it('Внешний вид пустого множественного поля', async function () {
      ...
      await bl.openExample('form-field-document', 'multiple-editable-empty');
      await form.waitForVisible();
     ...
     *   When Пользователь открывает в библиотеке блоков поле для чтения document
     *   Then Поле выглядит как положено
     */
    it('Внешний вид в режиме чтения', async function () {
      ...
      await bl.openExample('form-field-document', 'single-view');
      await form.waitForVisible();
     ...
     *   When Пользователь открывает в библиотеке блоков поле для чтения document пустое
     *   Then Поле выглядит как положено
     */
    it('Внешний вид пустого поля в режиме чтения', async function () {
      ...
      await bl.openExample('form-field-document', 'single-view-empty');
      await form.waitForVisible();
    ...
    it('Внешний вид множественного поля в режиме чтения', async function () {
      ...
      await bl.openExample('form-field-document', 'multiple-view');
      await form.waitForVisible();
    ...
    it('Внешний вид множественного поля в режиме чтения с переполнением', async function () {
      ...
      await bl.openExample('form-field-document', 'multiple-view-scroll');
      await form.waitForVisible();
    ...
    it('Внешний вид пустого множественного поля в режиме чтения', async function () {
      ...
      await bl.openExample('form-field-document', 'multiple-view-empty');
      await form.waitForVisible();
