Feature: Поле document: выбор документа в конкретных библиотеках
  ...
  Scenario: Если в схеме не указана библиотека, то при добавлении документа открывается диалог с выбором из всех имеющихся библиотек
    ...
    Then список названий в explorer: `Библиотека ЗУ`, `Градостроительное зонирование`, `Документы по проектам Геоплан`, `Документы территориального планирования муниципальных образований`, `Инженерные изыскания`, `Лесничества`, `Планировка территории`
