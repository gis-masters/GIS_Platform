Feature: Управление наборами данных
  ...
  Scenario: Администратор или владелец набора данных может его удалить 
  ...
  Scenario: Владелец или администратор набора данных не может его удалить если в нём есть таблица 
    Given существует набор данных "набор админ деление", созданный пользователем "Гарри"
