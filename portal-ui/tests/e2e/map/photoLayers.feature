Feature: Включение опции фотослой и прокол объектов, имеющих фотослои
  ...
  Scenario: При изменении опции `Фотослой` в свойствах слоя и сохранении её, изменённое значение сохраняется на сервере
    ...
    *     в диалоговом окне свойств слоя у формы в поле "Фотослой" типа choice я выбираю значение "Фотофиксация"
    *     жму кнопку `Esc`
