Feature: Прокол нескольких слоев
  ...
  Background:
    ...
    *     пользователем "Гарри" внутри созданного набора данных создана таблица "для прокола" по схеме "Схема с представлениями"
    ...
    *     пользователем "Гарри" внутри созданного набора данных создана таблица "для прокола 2" по схеме "Схема с представлениями"
