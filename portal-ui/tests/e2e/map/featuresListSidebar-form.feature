Feature: Форма объекта
  ...
  Scenario Outline: Вкладка просмотра атрибутов, в форме просмотра объекта, в режиме <режим> корректно отображает все типы полей
    Given существует заготовленная схема "Схема содержащая все типы данных в режиме <режим>"
    *     существует набор данных, созданный пользователем "Гарри"
    *     внутри созданного набора данных существует таблица по схеме "Схема содержащая все типы данных в режиме <режим>" созданная пользователем "Гарри"
    ...
    *     я нахожусь на странице карты проекта, открыт объект с id 1
  ...
  Scenario: Вкладка просмотра геометрии, в режиме чтения корректно отображает геометрию
    Given существует заготовленная схема "Схема содержащая все типы данных в режиме чтения"
    *     существует набор данных, созданный пользователем "Гарри"
    *     внутри созданного набора данных существует таблица по схеме "Схема содержащая все типы данных в режиме чтения" созданная пользователем "Гарри"
