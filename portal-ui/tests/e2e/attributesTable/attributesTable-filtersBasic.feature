Feature: Атрибутивная таблица: фильтрация - базовые сценарии
  ...
  Scenario Outline: Пользователь может фильтровать по числовым полям
    ...
    *     открыта атрибутивная таблица созданного слоя
    ...
    Then  фильтрация в атрибутивной таблице для атрибута "<fieldTitle>" соответствует ожидаемому: "<expected>"
  ...
  Scenario Outline: Пользователь может фильтровать данные по строковому полю. <description>
    ...
    *     я нахожусь на странице карты проекта
    *     открыта атрибутивная таблица созданного слоя
    When  в атрибутивной таблице я ввожу в поле "<fieldTitle>" значение "<filter>"
    Then  результат фильтрации в атрибутивной таблице по полю "<fieldTitle>" соответствует ожидаемому "<expected>"
  ...
  Scenario Outline: Пользователь может фильтровать по полю типа CHOICE
    ...
    *     я нахожусь на странице карты проекта
    *     открыта атрибутивная таблица созданного слоя
    When  в атрибутивной таблице в поле "<fieldTitle>" типа CHOICE я выбираю "<selected>"
    Then  результат фильтрации в атрибутивной таблице по полю "<checkedFieldTitle>" соответствует ожидаемому "<expected>"
  ...
  Scenario Outline: Пользователь может фильтровать по нескольким полям: "<firstFieldTitle>", "<secondFieldTitle>"
    ...
    *     в атрибутивной таблице в поле "<firstFieldTitle>" типа CHOICE я выбираю "<selected>"
    Then  результат фильтрации в атрибутивной таблице по полю "<checkedFieldTitle>" соответствует ожидаемому "<expected>"
