Feature: Пользователи
  ...
  # Тесты падают так как не работает рефреш токена.Создана задача №873 на починку рефреша. После неё тесты должны заработать.
  # Сейчас, так как меняются подчиненные у "Администратора организации", то его токен отзывается и требуется перелогин
  # администратора, что ломает тест.
  @skip()
