Feature: Геометрия объекта (редактируемые индексы координат)
  ...
  Scenario: Нумерация координат в раздели геометрии объекта типа "Полигон" корректна
  ...
  Scenario: Нумерация координат в раздели геометрии объекта типа "Мультиполигон" корректна
    Given существует заготовленная схема "Простая"
    *     существует набор данных, созданный пользователем "Гарри"
    *     существует проект "Проекции", созданный пользователем "Гарри"
  ...
  Scenario: Нумерация координат в раздели геометрии объекта типа "Линия" корректна
  ...
  Scenario: Нумерация координат в раздели геометрии объекта типа "Мультилиния" корректна
    Given существует заготовленная схема "геометрия Мультилиния"
    *     существует набор данных, созданный пользователем "Гарри"
    *     существует проект "Проекции", созданный пользователем "Гарри"
  ...
  Scenario: Нумерация координат в раздели геометрии объекта типа "Мультиточка" корректна
