...
import { pagesRegistry } from './_pagesRegistry';
import { blPage } from './BL.page';
import { dataManagementPage } from './DataManagement.page';
import { LibraryRegistryPage } from './LibraryRegistry.page';
...
Given('я на странице `Шаблоны отчётов` в управлении данными', async () => {
  await dataManagementPage.openReportTemplatesRootPage();
});
