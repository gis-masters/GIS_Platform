...
import { type Dataset, type VectorTable } from '../../src/app/services/data/vectorData/vectorData.models';
import { type NewWfsFeature } from '../../src/app/services/geoserver/wfs/wfs.models';
