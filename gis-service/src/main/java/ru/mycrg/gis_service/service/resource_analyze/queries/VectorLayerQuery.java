...
@Service
public class VectorLayerQuery implements IResourceQueryService {
    ...
    public VectorLayerQuery(ProjectService projectService, LayerService layerService) {
        this.layerService = layerService;
        this.projectService = projectService;

        resourceDefinition = new ResourceDefinition("VectorLayer", "Векторные слои");
    }
