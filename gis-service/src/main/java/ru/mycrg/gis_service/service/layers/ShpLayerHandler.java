...
@Component
public class ShpLayerHandler implements ILayerHandler {

    private final Logger log = LoggerFactory.getLogger(ShpLayerHandler.class);
    ...
    public ShpLayerHandler(LayerRepository layerRepository,
    ...
    public Optional<Layer> create(Project project, LayerCreateDto dto) {
        ...
        try {
            ...
            String msg = String.format("Не удалось опубликовать SHP слой %s на геосервере. Reason: %s",
