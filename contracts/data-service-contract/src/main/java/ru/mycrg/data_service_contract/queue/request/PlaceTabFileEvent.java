...
// TODO: Кто-нить, когда-нить это объединит! Главное верить! ))
public class PlaceTabFileEvent extends DefaultMessageBusRequestEvent implements Serializable {
    ...
    public PlaceTabFileEvent() {
        super(UUID.randomUUID(), DATA_TO_INTEGRATION_QUEUE);
    }

    public PlaceTabFileEvent(String token, ProcessModel processModel, UUID wsMsgId, String wsUiId,
