...
//Если ты тупая копипаста, то я тебя убью. Нужно отрефакторить ImportGpkgSucceededEventHandler а там видно будет
public class ImportGpkgReport {
