...
export CRG_DATA_SERVICE_TAG=latest
export CRG_REGISTRY_TAG=latest
export CRG_AUTH_TAG=latest
export CRG_GIS_SERVICE_TAG=latest
export CRG_GATEWAY_TAG=latest
export CRG_API_TAG=latest
export CRG_WRAPPER_TAG=latest
export CRG_UI_TAG=latest
