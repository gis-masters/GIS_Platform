...
public class LngLatAlt implements Serializable {
    ...
    /**
     * Construct a LngLatAlt with additional elements. The specification allows for any number of additional elements in
     * a position, after lng, lat, alt. http://geojson.org/geojson-spec.html#positions
     *
